...
add_filter('theme/index/sidebar/visibility', 'Rho\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'Rho\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'Rho\Setup\modify_excerpt_length');
