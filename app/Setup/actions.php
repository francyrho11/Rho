...
add_action('theme/index/post/thumbnail', 'Rho\Setup\render_post_thumbnail');
...
add_action('theme/single/content', 'Rho\Setup\render_post_content');
...
add_action('theme/index/content/none', 'Rho\Setup\render_empty_content');
...
add_action('theme/index/sidebar', 'Rho\Setup\render_sidebar');
add_action('theme/single/sidebar', 'Rho\Setup\render_sidebar');
...
add_action('theme/header/end', 'Rho\Setup\render_documentation_button');
