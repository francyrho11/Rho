...
add_action('wp_enqueue_scripts', 'Rho\Http\register_stylesheets');
...
add_action('wp_enqueue_scripts', 'Rho\Http\register_scripts');
...
add_action('admin_init', 'Rho\Http\register_editor_stylesheets');
...
add_action('wp_default_scripts', 'Rho\Http\move_jquery_to_the_footer');
